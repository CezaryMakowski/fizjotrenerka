      ...
      <ol>
        <li>
          ...
          <ol>
            <li>
              ...
              adresem url: <strong>fizjotrenerka.eu</strong>
            </li>
            <li>
              Operatorem serwisu oraz Administratorem danych osobowych jest:
              Patrycja Puszkarek Mariana Rapackiego 3, 71-467 Szczecin
            </li>
            <li>
              Adres kontaktowy poczty elektronicznej operatora:
              patipolerina96@gmail.com
            </li>
            <li>
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              pPliki cookies wykorzystywane są w następujących celach:
              <ol className={styles.abcStyle}>
                <li>
