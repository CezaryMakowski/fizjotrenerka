        ...
        <section className={styles.topWrapper}>
          ...
          <div>
            ...
            <p className={styles.topInfo}>
              ...
              stres i poprawiając nastrój. Dodatkowo, wybierając treningi
              online, oszczędzacie czas i pieniądze, które musiałbyście
              zainwestować w treningi personalne. To efektywna inwestycja w
              wasze zdrowie i dobre samopoczucie
            </p>
          </div>
        </section>
